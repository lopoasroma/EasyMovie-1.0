...
var consigli1 = videoLista(titolo: "Come ruotare un video su Mac", data: "25 Giu 2017", autore: "Fabrizio Gherardi", immagine: <#T##UIImage#>)
var consigli2 = videoLista(titolo: "Esportare un filmato senza perdita di qualità", data: "4 Ago 2014", autore: "Fabrizio Gherardi", immagine: UIImage)
var consigli3 = videoLista(titolo: "5 consigli per velocizzare il video editing", data: "18 Nov 2017", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
var consigli4 = videoLista(titolo: "Qual è il miglior formato per YouTube", data: "26 Dic 2017", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
var consigli5 = videoLista(titolo: "Come migliorare l'audio nei tuoi video", data: "4 Dic 2014", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
var consigli6 = videoLista(titolo: "Migliorare l'illuminazione nei tuoi video", data: "12 Dic 2014", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
var consigli7 = videoLista(titolo: "Come avere uno sfondo neutro", data: "16 Gen 2015", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
var consigli8 = videoLista(titolo: "Avere lo sfondo totalmente bianco stile Apple", data: "7 Mar 2015", autore: "PaoloG Youtube", immagine: <#T##UIImage#>)
